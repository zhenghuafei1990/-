	...
	<div id="mws-header" class="clearfix">
    	...
    	<div id="mws-logo-container">
        	...
        	<div id="mws-logo-wrap">
            	<img src="/logo/logo.png" alt="mws admin">
            ...
            <div id="mws-navigation">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="/admin/poster/create">广告添加</a></li>
                            <li><a href="/admin/poster">广告浏览</a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="#"><i class="icon-boat"></i> 收货人管理</a>
                        <ul class="closed">
                            <li><a href="/admin/usershome">收货浏览</a></li>
                        </ul>
                    </li>
                           
                    <li>
                        <a href="#"><i class="icon-file-openoffice"></i> 文章管理</a>
                        <ul class="closed">
                    ...
                    <li>
                        ...
                        <ul class='closed'>
                            <li><a href="/admin/lunbo/create">轮播添加</a></li>
                            <li><a href="/admin/lunbo">轮播浏览</a></li>
                        </ul>
                    </li>
