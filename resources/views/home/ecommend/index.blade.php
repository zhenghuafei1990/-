		...
		<section class="item-show__div item-show__head clearfix">
			<div class="pull-left">
				...
				<div class="item-pic__box" id="magnifier">
					...
					<div class="big-box"><img src="/{{$ecommend->picture}}" alt="{{$ecommend->gname}}"></div>
				</div>
					...
					<div class="item-price bgf5">
						<div class="price-box clearfix">
							<div class="price-panel pull-left">
								售价：<span class="price">￥{{$ecommend->price}}<s class="fz16 c9">￥{{($ecommend->price)*1.5}}</s></span>
							</div>
					...
					<div class="item-key">
						...
						<div class="item-amount clearfix bgf5">
							...
							<div class="amount-box">
								...
								<div class="item-stock"><span style="margin-left: 10px;">库存 <b id="Stock">{{$ecommend->stock}}</b> 件</span></div>
								<script>
									$(function () {
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade in active" id="detail" aria-labelledby="detail-tab">
						<div class="item-detail__info clearfix">
							...
							<div class="record">商品库存：{{$ecommend->stock}}件</div>
						</div>
						<div class="rich-text">
