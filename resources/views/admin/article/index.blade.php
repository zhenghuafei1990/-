        ...
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            <form method="get" action="/admin/article">
                ...
                <div class="dataTables_filter" id="DataTables_Table_1_filter">
                    <label>
                        用户名:
                        <input aria-controls="DataTables_Table_1"  name="wname" type="text" value="{{$request->wname}}" />
                    </label>
            ...
            aria-describedby="DataTables_Table_1_info" style="text-align:center;">
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="@if($k % 2==0)odd @else even @endif">
                        ...
                        <td class=" ">
                            {!!date('Y-m-d H:i:s',$v->wtime)!!}
                        </td>

                        <td class=" ">
                            <a class="btn btn-primary" href="/admin/article/{{$v->wid}}/edit">修改</a>
                            <form action="/admin/article/{{$v->wid}}" method="post" style="display: inline;">
                                {{csrf_field()}}
                                {{method_field('DELETE')}}
